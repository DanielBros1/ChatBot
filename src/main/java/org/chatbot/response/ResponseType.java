...
public enum ResponseType {
    WELCOME("Witaj w Chatbot Rezerwacji! Aby zrobić rezerwację, wpisz 'Rezerwuj'. " +
            "Aby pokazać listę rezerwacji, wpisz 'Pokaż rezerwacje'. " +
            "Aby usunąć rezerwację, wpisz 'Usuń rezerwację [ID]'."),
